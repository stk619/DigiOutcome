...
public:
	...
	void text_font(hFont uiFont)
	{
		return nUtilities::vfunc<void(__thiscall*)(ISurface*, hFont)>(this, SETTEXTFONT)(this, uiFont);
	}
	...
	hFont create_font()
	{
		return nUtilities::vfunc<hFont(__thiscall*)(ISurface*)>(this, CREATEFONT)(this);
	}
	...
	void get_text_size(hFont uiFont, const wchar_t* szText, int& iWidth, int& iHeight)
	{
		return nUtilities::vfunc<void(__thiscall*)(ISurface*, hFont, const wchar_t*, int&, int&)>(this, GETTEXTSIZE)(this, uiFont, szText, iWidth, iHeight);
	}
