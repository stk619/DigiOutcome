...
//handles a wide variety of networked variables, a list can be found here:
...
namespace nNetvarManager
{
	...
	//mapped list that contains the offset of our netvar, unordered map because it's slightly quicker than std::map
