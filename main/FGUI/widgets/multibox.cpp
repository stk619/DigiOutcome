...
namespace FGUI
{
  ...
  void CMultiBox::Geometry(FGUI::WIDGET_STATUS status)
  {
    ...
    FGUI::RENDER.Text(arWidgetRegion.m_iLeft + (dmTitleTextSize.m_iWidth + 20), arWidgetRegion.m_iTop + (arWidgetRegion.m_iBottom / 2) - (dmTitleTextSize.m_iHeight / 2), m_anyFont, {255, 255, 255}, strMultiString);
    ...
    if (m_bIsOpened)
    {
      ...
      FGUI::RENDER.Rectangle((arWidgetRegion.m_iLeft + 1), (arWidgetRegion.m_iTop + 21) + 1, (arWidgetRegion.m_iRight - 2), (m_prgpEntries.first.size() * m_iEntrySpacing) - 2, {22, 22, 22});
      ...
      for (std::size_t i = 0; i < m_prgpEntries.first.size(); i++)
      {
        ...
        if (FGUI::INPUT.IsCursorInArea(arEntryRegion) || m_prgpEntries.second[i])
          FGUI::RENDER.Rectangle(arEntryRegion.m_iLeft + 2, arEntryRegion.m_iTop + 2, arEntryRegion.m_iRight - 4, arEntryRegion.m_iBottom - 4, {35, 35, 35});
    ...
    if (m_bIsOpened)
    {
        FGUI::RENDER.Rectangle((arWidgetRegion.m_iLeft + arWidgetRegion.m_iRight - 10) - 8, arWidgetRegion.m_iTop + ((arWidgetRegion.m_iBottom / 2) - 3) + 1, 8, 1, { 22, 22, 22 });
        FGUI::RENDER.Rectangle((arWidgetRegion.m_iLeft + arWidgetRegion.m_iRight - 10) - 7, arWidgetRegion.m_iTop + ((arWidgetRegion.m_iBottom / 2) - 3) + 2, 6, 1, { 22, 22, 22 });
        FGUI::RENDER.Rectangle((arWidgetRegion.m_iLeft + arWidgetRegion.m_iRight - 10) - 6, arWidgetRegion.m_iTop + ((arWidgetRegion.m_iBottom / 2) - 3) + 3, 4, 1, { 22, 22, 22 });
        FGUI::RENDER.Rectangle((arWidgetRegion.m_iLeft + arWidgetRegion.m_iRight - 10) - 5, arWidgetRegion.m_iTop + ((arWidgetRegion.m_iBottom / 2) - 3) + 4, 2, 1, { 22, 22, 22 });
    }
    else
    {
        FGUI::RENDER.Rectangle((arWidgetRegion.m_iLeft + arWidgetRegion.m_iRight - 10) - 8, arWidgetRegion.m_iTop + ((arWidgetRegion.m_iBottom / 2) - 3) + 4, 8, 1, { 22, 22, 22 });
        FGUI::RENDER.Rectangle((arWidgetRegion.m_iLeft + arWidgetRegion.m_iRight - 10) - 7, arWidgetRegion.m_iTop + ((arWidgetRegion.m_iBottom / 2) - 3) + 3, 6, 1, { 22, 22, 22 });
        FGUI::RENDER.Rectangle((arWidgetRegion.m_iLeft + arWidgetRegion.m_iRight - 10) - 6, arWidgetRegion.m_iTop + ((arWidgetRegion.m_iBottom / 2) - 3) + 2, 4, 1, { 22, 22, 22 });
        FGUI::RENDER.Rectangle((arWidgetRegion.m_iLeft + arWidgetRegion.m_iRight - 10) - 5, arWidgetRegion.m_iTop + ((arWidgetRegion.m_iBottom / 2) - 3) + 1, 2, 1, { 22, 22, 22 });
    }
  }
  ...
  void CMultiBox::Load(nlohmann::json &module)
  {
    ...
    if (module.contains(strFormatedWidgetName))
    {
      for (std::size_t i = 0; i < m_prgpEntries.first.size(); i++)
      {
        ...
        if (module[strFormatedWidgetName].contains(strFormatedEntryName))
        {
