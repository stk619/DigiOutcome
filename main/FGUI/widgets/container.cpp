...
namespace FGUI
{
  ...
  {
    m_nCursorStyle = static_cast<int>(FGUI::CURSOR_STYLE::ARROW);
  ...
  void CContainer::Geometry(FGUI::WIDGET_STATUS status)
  {
    ...
    if (!GetParentWidget())
    {
      ...
      FGUI::RENDER.Rectangle(arWidgetRegion.m_iLeft + 1, arWidgetRegion.m_iTop + 31, arWidgetRegion.m_iRight - 2, (arWidgetRegion.m_iBottom - 30) - 2, {22, 22, 22});
    ...
    else // otherwise, behave like a normal groupbox
    {
      ...
      {
        FGUI::RENDER.Rectangle(arWidgetRegion.m_iLeft, arWidgetRegion.m_iTop, 5, 1, { 40, 40, 40 });                                                                                           // top1
        FGUI::RENDER.Rectangle((arWidgetRegion.m_iLeft + dmTitleTextSize.m_iWidth) + 16, arWidgetRegion.m_iTop, (arWidgetRegion.m_iRight - dmTitleTextSize.m_iWidth) - 16, 1, { 40, 40, 40 }); // top2
      }
      else
      {
        FGUI::RENDER.Rectangle(arWidgetRegion.m_iLeft, arWidgetRegion.m_iTop, arWidgetRegion.m_iRight, 1, { 40, 40, 40 }); // top1
      }

      FGUI::RENDER.Rectangle(arWidgetRegion.m_iLeft, arWidgetRegion.m_iTop, 1, arWidgetRegion.m_iBottom, { 40, 40, 40 });                                               // left
      FGUI::RENDER.Rectangle((arWidgetRegion.m_iLeft + arWidgetRegion.m_iRight), arWidgetRegion.m_iTop, 1, arWidgetRegion.m_iBottom, { 40, 40, 40 });                   // right
      FGUI::RENDER.Rectangle(arWidgetRegion.m_iLeft, (arWidgetRegion.m_iTop + arWidgetRegion.m_iBottom), arWidgetRegion.m_iRight + 1, 1, { 40, 40, 40 });                   // bottom
      FGUI::RENDER.Rectangle((arWidgetRegion.m_iLeft + 2), (arWidgetRegion.m_iTop + 2), (arWidgetRegion.m_iRight - 3), (arWidgetRegion.m_iBottom - 3), { 30, 30, 30 }); // background
      ...
      if (m_bScrollBarState)
      {
        ...
        // scrollbar thumb
        FGUI::RENDER.Rectangle((arScrollBarRegion.m_iLeft + 4), static_cast<float>((arScrollBarRegion.m_iTop + flScrollbarThumbPosition) + 5), dmScrollBarThumbWidth.m_iWidth, static_cast<int>(flScrollbarThumbSize), {220, 223, 231});
      }
    }
    ...
    else // if the container is behaving like a groupbox
    {
      if (m_bScrollBarState)
      {
        ...
        if (bIsDraggingThumb)
        {
          ...
          static constexpr int iLinesToScroll = 2; // feel free to change this
