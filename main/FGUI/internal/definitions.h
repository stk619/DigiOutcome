...
namespace FGUI
{
  ...
  using COLOR = struct SColor_t
  {
    ...
    static SColor_t Interpolate(SColor_t color1, SColor_t color2, float ttt)
    {
      ...
      return SColor_t(static_cast<uint8_t>(flRed), static_cast<uint8_t>(flGreen), static_cast<uint8_t>(flBlue), static_cast<uint8_t>(flAlpha));
    }
    ...
    static SColor_t HSBToRGB(float hue, float saturation, float brightness, std::uint8_t alpha = 255)
    {
      ...
      if (flHue < 1.f)
      {
        return SColor_t((static_cast<uint8_t>(brightness) * 255), (static_cast<uint8_t>(flT) * 255), (static_cast<uint8_t>(flP) * 255), alpha);
      }
      else if (flHue < 2.f)
      {
        return SColor_t((static_cast<uint8_t>(flQ) * 255), (static_cast<uint8_t>(brightness) * 255), (static_cast<uint8_t>(flP) * 255), alpha);
      }
      else if (flHue < 3.f)
      {
        return SColor_t((static_cast<uint8_t>(flP) * 255), (static_cast<uint8_t>(brightness) * 255), (static_cast<uint8_t>(flT) * 255), alpha);
      }
      else if (flHue < 4.f)
      {
        return SColor_t((static_cast<uint8_t>(flP) * 255), (static_cast<uint8_t>(flQ) * 255), (static_cast<uint8_t>(brightness) * 255), alpha);
      }
      else if (flHue < 5.f)
      {
        return SColor_t((static_cast<uint8_t>(flT) * 255), (static_cast<uint8_t>(flP) * 255), (static_cast<uint8_t>(brightness) * 255), alpha);
      }
      else
      {
        return SColor_t((static_cast<uint8_t>(brightness) * 255), (static_cast<uint8_t>(flP) * 255), (static_cast<uint8_t>(flQ) * 255), alpha);
      }
    }
