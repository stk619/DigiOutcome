...
#include "../widgets/keybinder.h"
#include "../widgets/label.h"
#include "../widgets/listbox.h"
#include "../widgets/multibox.h"
...
namespace FGUI
{
  ...
  public:
    ...
    // THE WIDGET NEEDS TO BE INITIALIZED FIRST!
    ...
    // this is used as a form of optimization for ColorPicker.
    ...
    // key = selected key on keybinders
    ...
    // state = set the CheckBox state (checked or not)
    ...
    // for tab panels i recommend using the "Tab" function instead of this one
